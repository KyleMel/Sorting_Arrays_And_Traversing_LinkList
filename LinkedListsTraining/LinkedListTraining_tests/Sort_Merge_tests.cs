...
namespace LinkedListTraining_tests
{
    ...
    public class Sort_Merge_tests
    {
        ...
        {
            var input = new int[] { 5, 6, 5, 6, 5, 6, 5, 6 };
        ...
        {
            var input = new int[] { 99999, Int32.MaxValue, Int32.MinValue, 10, 44, -1111, 0, 2, 2, 2, -1 };
